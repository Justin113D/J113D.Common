...
{
	/// <summary>
	/// Base cross platform settings class
	/// </summary>
	public abstract class BaseSettings
	{
		...
		/// <summary>
		/// Obtain settings value by name
		/// </summary>
		/// <param name="name">Name of the settings value</param>
		/// <returns></returns>
		...
		/// <summary>
		/// Convert a json value to a custom internal type
		/// </summary>
